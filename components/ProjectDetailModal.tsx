            ...
            {isOpen && project && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6">
                    ...
                    <motion.div
                        ...
                        className="bg-white w-full max-w-6xl h-[85vh] md:h-[85vh] rounded-[2rem] shadow-2xl z-10 relative flex flex-col md:flex-row overflow-hidden border border-white/20"
                    >
                        {/* 
                        ...
                        */}
                        ...
                        <button
                            ...
                            className="absolute top-4 right-4 z-50 p-2 rounded-full bg-slate-100/80 hover:bg-slate-200 text-slate-700 transition-colors shadow-sm backdrop-blur-md"
                        >
                            <X size={24} />
                        </button>
                        ...
                        <div className="flex flex-col md:flex-row w-full h-full overflow-y-auto md:overflow-hidden">
                            ...
                            {/* Sidebar */}
                            <div className="bg-slate-50 p-8 md:p-10 w-full md:w-[35%] border-r border-slate-200 flex flex-col shrink-0 md:overflow-y-auto">
                                <div className="mb-8">
                            ...
                            {/* Content */}
                            <div className="p-8 md:p-12 w-full md:w-[65%] bg-white md:overflow-y-auto custom-scrollbar">
